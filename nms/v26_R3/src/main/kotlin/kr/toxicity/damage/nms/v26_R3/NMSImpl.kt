package kr.toxicity.damage.nms.v26_R3
...
class NMSImpl : NMS {
    ...
    private class DamageDisplayImpl(
        ...
        private val display: Display = Display.TextDisplay(EntityTypes.TEXT_DISPLAY, (location.world as CraftWorld).handle).apply { //Remap bug :(
        ...
        override fun update() {
            val sync = ClientboundEntityPositionSyncPacket(display.id, PositionPath.of(display.position()), display.yRot, display.xRot, display.onGround)
